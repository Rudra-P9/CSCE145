...
public class DecisionsGame {
	...
	public static void main(String[] args) {
		...
		System.out.println("Contestant1: I will give you this marker. Would you like to keep it or trade it with\'s on my desk or what\'s in my bag. Enter \"keep\", \"desk\" or \"bag\":");
		...
		else if(response.equalsIgnoreCase("keep"))
		{
			...
			System.out.println("Contestant2: Would you like to pick what\'s in my desk. Enter \"desk\" or \"bag\": ");
		...
		else if(response.equalsIgnoreCase("bag"))
		{
			...
			System.out.println("Contestant2: Would you like to keep this marker or pick what\'s on my desk. Enter \"keep\"or \"desk\":");
